...
<script type="module" src="../assets/js/earth.js">
import * as THREE from 'three';
    ...
    function init() {
        ...
        //TEXTURE
        let texture = new THREE.TextureLoader().load( "../assets/textures/2k_earth_daymap.jpg" );
        texture.wrapS = THREE.RepeatWrapping;
        texture.wrapT = THREE.RepeatWrapping;
        texture.repeat.x = 1;      //Horizontal x10
        texture.repeat.y = 1;       //Vertical x6

        let moon_texture = new THREE.TextureLoader().load( "../assets/textures/moon_8k.jpg" );
